...
export default async function handler(req: NextApiRequest, res: NextApiResponse<any>) {
  try {
    ...
    // This dummy api endpoint offset does not work and return same result
    const getRes = await fetch(`${APP_API_BASE_URL}?offset=${req.query.offset}&limit=${req.query.limit}`, {
      method: 'GET',
      headers: {
